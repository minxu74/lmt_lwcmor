...
UserInput["physics_index"        ] = np.int32(11)
UserInput["realization_index"    ] = np.int32(1)
UserInput["variant_info"         ] = "p = 11, for 0.5 degree resolution of E3SM simulation"
...
if mip_name == "C4MIP" and rel_name == "ocean":
    xrel_name = "atmos"
